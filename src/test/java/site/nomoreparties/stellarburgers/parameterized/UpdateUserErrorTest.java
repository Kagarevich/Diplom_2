...
public class UpdateUserErrorTest {
    ...
    @Test
    @DisplayName("Тест \"Изменение данных пользователя без авторизации\"")
    @Description("пытаемся изменить данные пользователя -> сравниваем тело ответа с ожидаемым")
    public void updateUserNotAuthErrorTest() {
